...
| [Monitoring](docs/technical/MONITORING.md) | Health, logs and alerting — Netdata, log rotation |
...
| Netdata | http://localhost:19999 | Host + container health, alerting ([Monitoring](docs/technical/MONITORING.md)) |
